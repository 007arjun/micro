...
class _HomeScreenAdminWidgetState extends State<HomeScreenAdminWidget> {
  ...
  Future<void> _insertProduct(Map<String, dynamic> productData) async {
    try {
  ...
  Future<List<Product>> _getProductList() async {
    try {
      List<Map<String, dynamic>> productListFromDB = await SQLHelper().getAllProducts();

      List<Product> productList = productListFromDB
          .where((productMap) => productMap['userId'] == userUniqueIdentifier)
          .map((productMap) {
        return Product(
          productMap['name'],
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                final Map<String, dynamic>? result = await
                Navigator.push(
                  context,
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => TestFormWidget()
                      ),
                    );
                  },
                  child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    ...
                    image: product.imagePath != null
                        ? FileImage(File(product.imagePath)) as ImageProvider<Object>
...
class Product {
  ...
  Product(this.name, this.description, this.addedDate, this.imagePath, this.batchName);
}