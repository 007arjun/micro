                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () async {
                                  // Navigate to EditFormWidget and wait for result
                                  ...
                                  if (result != null && result is Map<String, dynamic>) {
                                    if (result.containsKey('formId') && result.containsKey('formTitle')) {
                                      // Only update the formId and form title if they were changed
                                      setState(() {
...
Future<Map<String, dynamic>> fetchFormDetails(int formId) async {
  ...
  if (formDetails.isNotEmpty) {
    // Fetch the latest details by querying the form again
