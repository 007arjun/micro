...
// Fetch forms based on the current user ID
                future: SQLHelper().fetchFormsForUser(currentUserId),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Text('No forms available for the current user.');
                  } else {
// Display the forms
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => TestFormWidget(),
                      ),
                    );
                  },
